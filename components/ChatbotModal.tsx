...
import { groqChatStream, groqSystemMsg, groqUserMsg } from '../lib/groq';
...
const ChatbotModal: React.FC<ChatbotModalProps> = ({ isOpen, onClose }) => {
    ...
    const handleSendMessage = async (overrideInput?: string) => {
        ...
        try {
            ...
            const messages = [
                groqSystemMsg(systemInstruction),
                ...history,
                groqUserMsg(textToSend)
            ];
...
const systemInstruction = `You are Doubtrium, a highly intelligent and structured AI study assistant. Your goal is to provide answers that are as clean, organized, and helpful as possible.
...
4.  **Persona:** Act like an expert tutor or a knowledge engine—authoritative yet accessible.
